...
namespace SuperHornet422.Ship
{
    ...
    {
        public static List<EnemyShip> CreateEnemyWave(Point Location, Path PathToFollow, int NumberOfShips, ShipType shipType, ShipFunctions sf)
        {
            int i = 0;
            ...
            if (shipType == ShipType.basicLevel1)
            {
                while (i <= NumberOfShips)
                {
                    ...
                    ships.Add(EnemyShipFactory.CreateEnemyShipBasicLevel1(Location, PathToFollow, sf));
                    i++;
                }
            }
            else if (shipType == ShipType.strongLevel2)
            {
                while (i <= NumberOfShips)
                {
                    ...
                    ships.Add(EnemyShipFactory.CreateEnemyShipStrongLevel2(Location, PathToFollow, sf));
                    i++;
                }
            ...
            else if (shipType == ShipType.fastLevel3)
            {
                while (i <= NumberOfShips)
                {
                    ...
                    ships.Add(EnemyShipFactory.CreateEnemyShipFastLevel3(Location, PathToFollow, sf));
                    i++;
                }
            ...
            else if (shipType == ShipType.strongLevel4)
            {
                while (i <= NumberOfShips)
                {
                    ...
                    ships.Add(EnemyShipFactory.CreateEnemyShipStrongLevel4(Location, PathToFollow, sf));
                    i++;
                }
            ...
            else if (shipType == ShipType.basicLevel5)
            {
                while (i <= NumberOfShips)
                {
                    ...
                    ships.Add(EnemyShipFactory.CreateEnemyShipBasicLevel5(Location, PathToFollow, sf));
                    i++;
                }
